...
interface OrderRepositoryInterface extends BaseRepositoryInterface {
    ...
    public function fetchByProductOwnerAndCustomer($user_id, $customer_id, $limit, $filters);
    public function countByProductOwner($user_id, $filters);
    public function countByProductOwnerAndCustomer($user_id, $customer_id, $filters);
    ...
    public function topRetailersByProductOwner($user_id, $filters, $limit);
}
